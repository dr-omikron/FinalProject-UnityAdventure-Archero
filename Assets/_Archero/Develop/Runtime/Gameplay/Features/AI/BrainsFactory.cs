...
namespace _Archero.Develop.Runtime.Gameplay.Features.AI
{
    public class BrainsFactory
    {
        ...
        private readonly AIBrainContext _aiBrainContext;
        ...
        public StateMachineBrain CreateGhostBrain(Entity entity)
        {
            ...
            _aiBrainContext.SetFor(entity, brain);
        ...
        public StateMachineBrain CreateMainHeroBrain(Entity entity, ITargetSelector targetSelector)
        {
            ...
            AIParallelState aiParallelState = new AIParallelState(findTargetState, behaviour);
        ...
        private AIStateMachine CreateRandomMovementStateMachine(Entity entity)
        {
            ...
            TimerService movementTimer = _timerServiceFactory.Create(2.0f);
            disposables.Add(movementTimer);
            disposables.Add(randomMovementState.Entered.Subscribe(movementTimer.Restart));

            TimerService idleTimer = _timerServiceFactory.Create(3.0f);
